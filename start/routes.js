...
Route.group(() => {
  ...
  Route.post('groups/:group_id/addUserToGroup', 'GroupController.addUserToGroup');
  ...
  Route.delete('surgeries/:surgery_id/procedures', 'SurgeryController.removeProcedures');

  //Adicionar procedimentos a cirurgia
  Route.post('surgeries/:surgery_id/procedures', 'SurgeryController.addProcedures');
